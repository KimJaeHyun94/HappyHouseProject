...
public class PageNavigation {
	...
	private int naviSize;//navigation사이즈
	private int countPerPage;//페이지당 글 개수
	private String navigator;//뿌려주는거
	...
	public void makeNavigator() {
		int startPage = (currentPage-1)/naviSize*naviSize+1;//현재페이지 기준 첫 페이지
		int endPage = startPage+naviSize-1;//현재 페이지 기준 끝 페이지
